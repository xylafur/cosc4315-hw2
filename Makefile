...
RECURSE=$(UTIL_SOURCE)recursion_detector.cpp
RECURSE_OBJECT=$(OBJECTS_DIR)recursion_detector.o


UTIL_OBJECTS=$(GEN_UTIL_OBJECT) $(IF_ELSE_OBJECT) $(MUTATION_OBJECT) $(RECURSE_OBJECT)
...
$(RECURSE_OBJECT): objects
	$(CC) $(CC_FLAGS) -c $(RECURSE) -o $(RECURSE_OBJECT)
