...
VARIABLE_TABLE=$(EXECUTION_SOURCE)variables.cpp
VARIABLE_TABLE_OBJECT=$(OBJECTS_DIR)variables.o

EXECUTION_OBJECTS=$(VIRTUAL_MACHINE_OBJECT) $(BCODE_GEN_OBJECT) $(VARIABLE_TABLE_OBJECT)


MAIN=$(SOURCE)main.cpp
MAIN_OBJECT=$(OBJECTS_DIR)main.o

OBJECTS=$(PARSING_OBJECTS) $(UTIL_OBJECTS) $(MAIN_OBJECT) $(VARIABLE_TABLE_OBJECT)#$(EXECUTION_OBJECTS)
...
$(VARIABLE_TABLE_OBJECT): objects parser
	$(CC) $(CC_FLAGS) -c $(VARIABLE_TABLE) -o $(VARIABLE_TABLE_OBJECT)
