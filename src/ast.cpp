...
node_ptr create_expr_node(char c_operator, int num_children, node_array children)
{
    create_node(ret);
    ret->type = EXPR;
    ret->num_children = num_children;
    ret->c_operator = c_operator;
    ret->children = children;
